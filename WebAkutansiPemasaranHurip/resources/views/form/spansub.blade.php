...
<body>
    <div class="page">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-left">
                <strong>No. </strong><span class="editable large-size">{{ $spansub->no_inv }}</span>
            </div>
        </div>
        ...
        <div class="table-desc">
            <table class="table-desc no-border">
                <tr>
                    ...
                    <td>: {{ $spansub->nopolisi }}</td>
                </tr>
                <tr>
                    <td>Tanggal</td>
                    <td>: {{ $spansub->tgl_inv }}</td>
                </tr>
                <tr>
                    <td>Delivery Order Nomor</td>
                    <td>: {{ $deliveryOrder->no_DO }} Party <span class="editable no-border">{{ $spansub->party }} Ton/Kg/Dus</span></td>
                </tr>
                <tr>
        ...
        <footer>
            ...
            <div class="text-center">
                ...
                <div class="editable no-border">{{ $spansub->nm_pengirim }}</div>
                <p>Tgl. ............................</p> 
            </div>
        </footer>
    </div>
    <div class="back-button-container">
        <a href="/spansub" class="btn-back">Back</a>
    </div>
