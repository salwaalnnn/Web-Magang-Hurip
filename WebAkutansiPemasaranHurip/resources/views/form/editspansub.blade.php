...
<body>
    <div class="page">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-left">
                <strong>No. </strong><span class="editable large-size">[Invoice Number]</span>
            </div>
        </div>
        <div class="text-center my-3">
            <h2>SURAT PENGANTAR</h2>
            <hr size="1" color="black" noshade style="width: 40%;">
            <h3>ALOKASI NON SUBSIDI</h3>
        </div>
        <div class="table-desc">
            <table class="table-desc no-border">
                <tr>
                    <td style="width: 120px;" contenteditable="true">Nomor Pol. Kendaraan</td>
                    <td contenteditable="true">: [No Polisi]</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td contenteditable="true">Delivery Order Nomor</td>
                    <td contenteditable="true">: [No Delivery Order] Party<span class="editable no-border">[Party] Ton/Kg/Dus</span></td>
                </tr>
                <tr>
                    <td style="text-align:right;" contenteditable="true">Tanggal</td>
                    <td contenteditable="true">: [Tanggal DO]</td>
                </tr>
                <tr>
                    <td contenteditable="true">Gudang Tujuan </td>
                    <td contenteditable="true">: [Gudang Tujuan]</td>
                </tr>
                <tr>
                    <td contenteditable="true">Kabupaten / Kota</td>
                    <td contenteditable="true">: [Kabupaten / Kota]</td>
                </tr>
            </table>
        </div>
        <table class='isi'>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="editable">[Quantity Ton]</td>
                    <td class="editable">[Quantity Zak]</td>
                    <td>
                        <ul>
                            <li>RUSAK ......... Zak = ......... Kg</li>
                            <li>HILANG ......... Zak = ......... Kg</li>
        ...
        <footer>
            <div class="text-center">
                ...
                <div class="editable no-border">[Nama Penerima]</div>
                <p>Tgl. ............................</p>
            </div>
            <div class="text-center">
                Dikirim Oleh,<br><br><br><br>
                <div class="editable no-border">[Nama Pengirim]</div>
                <p>Tgl. ............................</p>
            </div>
        </footer>
    </div>
